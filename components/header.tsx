  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b bg-background px-4 md:px-6">
      <Link href="/" className="flex items-center gap-2">
        ...
        <span className="hidden text-xl font-bold sm:inline-block">Campus Housing</span>
      </Link>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-80">
            ...
            <div className="max-h-96 overflow-auto">
              {[1, 2, 3].map((item) => (
                <DropdownMenuItem key={item} className="flex flex-col items-start p-4">
                  <div className="font-medium">Maintenance Update</div>
                  <div className="text-sm text-muted-foreground">Your maintenance request has been processed.</div>
